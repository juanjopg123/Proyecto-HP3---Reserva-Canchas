        ...
        <div class="p-6 max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                @forelse($canchas as $cancha)
                    <div class="bg-white shadow-xl rounded-2xl p-5 flex flex-col items-center text-center 
                        ...
                        <!-- Tipo -->
                        <p class="text-gray-600 mb-1">{{ ucfirst($cancha->tipo) }}</p>

                        <!-- Precio -->
                        <p class="text-lg font-semibold text-green-600 mb-1">
                        ...
                        <button onclick="openForm('{{ $cancha->id }}','{{ e($cancha->nombre) }}')" 
                            class="w-full px-5 py-2.5 rounded-xl font-semibold text-white 
                                   ...
                                   shadow-md hover:from-blue-400 hover:to-indigo-500 
                ...
                @empty
                    <p class="col-span-3 text-center text-gray-600">
                        No hay canchas de fútbol registradas todavía.
                    </p>
                @endforelse
            </div>
            ...
            <div id="reservaModal" 
                ...
                <div class="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-lg relative animate-fade-in">
                    ...
                    <h2 id="formTitle" class="text-3xl font-extrabold mb-6 text-green-600 text-center">Reserva</h2>
                    ...
                    <form action="{{ route('reservas.store') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha" 
                                   class="w-full border-2 border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-green-400"
                        ...
                        <div class="flex justify-end gap-4 mt-6">
                            ...
                            <button type="submit"
                                    class="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-2 rounded-xl shadow-lg hover:from-green-600 hover:to-emerald-700 transition">
                                Confirmar ✅
                            </button>
                        </div>
                    </form>
            ...
            <div class="mt-12">
                ...
                @if($reservas->isEmpty())
                    <p class="text-gray-600">No tienes reservas de canchas de fútbol.</p>
                @else
                            ...
                            <tbody class="text-gray-700">
                                @foreach($reservas as $reserva)
                                    <tr class="border-t hover:bg-green-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 text-center">{{ ucfirst($reserva->cancha->tipo) }}</td>
