        ...
        <div class="p-6 max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                @forelse($canchas as $cancha)
                    <div class="bg-white shadow-xl rounded-2xl p-5 flex flex-col items-center text-center 
                        ...
                        <!-- Precio -->
                        <p class="text-lg font-semibold text-orange-600 mb-1">
                        ...
                        <button onclick="openForm('{{ $cancha->id }}','{{ e($cancha->nombre) }}')" 
                            class="w-full px-5 py-2.5 rounded-xl font-semibold text-white 
                                   ...
                                   shadow-md hover:from-orange-400 hover:to-red-500 
                ...
                @empty
                    <p class="col-span-3 text-center text-gray-600">
                        No hay canchas de básquetball registradas todavía.
                    </p>
                @endforelse
            </div>
            ...
            <div id="reservaModal" 
                ...
                <div class="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-lg relative animate-fade-in">
                    ...
                    <h2 id="formTitle" class="text-3xl font-extrabold mb-6 text-orange-600 text-center">Reserva</h2>
                    ...
                    <form action="{{ route('reservas.store') }}" method="POST" class="space-y-5">
                        ...
                        <div class="flex justify-end gap-4 mt-6">
                            ...
                            <button type="submit"
                                    class="bg-gradient-to-r from-orange-500 to-yellow-600 text-white px-6 py-2 rounded-xl shadow-lg hover:from-orange-600 hover:to-red-600 transition">
                                Confirmar ✅
                            </button>
                        </div>
                    </form>
            ...
            <div class="mt-12">
                ...
                @if($reservas->isEmpty())
                    <p class="text-gray-600">No tienes reservas de canchas de básquetball.</p>
                @else
